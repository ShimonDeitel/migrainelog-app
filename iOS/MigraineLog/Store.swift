...
final class Store: ObservableObject {
    ...
    private let fileName = "migrainelog_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Episode One", detail: "First example entry.", date: now),
            Entry(title: "Sample Episode Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Episode Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
