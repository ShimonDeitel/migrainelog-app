        ...
        NavigationStack {
            ...
            .overlay {
                if store.entries.isEmpty {
                    ContentUnavailableView("No Episodes Yet", systemImage: "tray", description: Text("Tap + to add your first entry."))
                }
            }
        ...
        NavigationStack {
            Form {
                Section("Episode") {
                    ...
                    TextField("Details (severity, trigger)", text: $detail)
                    DatePicker("Date", selection: $date, displayedComponents: .date)
                }
            }
            .navigationTitle(entry == nil ? "Add Episode" : "Edit Episode")
            .toolbar {
